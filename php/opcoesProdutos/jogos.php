   ...
   <div class='barra'>
    ...
    <div class='container'>
        ...
        <div class='produtos'>
            <!-- PRODUTO 1 -->
            <div class='card' id='1'>
                <img class='imagemProduto' src='figs jogos/among us.png' />
                <h4> Among Us </h4>
            ...
            <!-- PRODUTO 2 -->
            <div class='card'>
                <img class='imagemProduto' src='figs jogos/cogumelos super mario.png' />
                <h4> Cogumelos Super Mário </h4>
                <div class='valorProduto'>
                    <h5> R$4,00</h5>
                </div>
                <a> Adicionar ao Carrinho </a>
            ...
            <!-- PRODUTO 3 -->
            <div class='card'>
                <img class='imagemProduto' src='figs jogos/coracoes minecraft.png' />
                <h4> Corações do Minecraft </h4>
                <div class='valorProduto'>
                    <h5> R$4,00</h5>
                </div>
                <a> Adicionar ao Carrinho </a>
            ...
            <!-- PRODUTO 4 -->
            <div class='card' id='4'>
                <img class='imagemProduto' src='figs jogos/dinossauro google.png' />
                <h4> Dino Do Google </h4>
                <div class='valorProduto'>
                    <h5> R$4,00</h5>
                </div>
                <a> Adicionar ao Carrinho </a>
            ...
            <!-- PRODUTO 5 -->
            <div class='card'>
                <img class='imagemProduto' src='figs jogos/donkey kong.png' />
                <h4> Donkey Kong</h4>
                <div class='valorProduto'>
                    <h5> R$4,00</h5>
                </div>
            ...
            <!-- PRODUTO 6 -->
            <div class='card'>
                <img class='imagemProduto' src='figs jogos/luigi.png' />
                <h4> Luigi </h4>
                <div class='valorProduto'>
                    <h5> R$4,00</h5>
                </div>
            ...
            <!-- PRODUTO 7 -->
            <div class='card'>
                <img class='imagemProduto' src='figs jogos/lutador video game antigo.png' />
                <h4> Ryu - Street Fighter</h4>
                <div class='valorProduto'>
                    <h5> R$4,00</h5>
                </div>
                <a> Adicionar ao Carrinho </a>
            ...
            <!-- PRODUTO 8 -->
            <div class='card'>
                <img class='imagemProduto' src='figs jogos/miguel sabe o nome.png' />
                <h4> Bixinho do Pokemon </h4>
                <div class='valorProduto'>
                    <h5> R$4,00</h5>
                </div>
                <a> Adicionar ao Carrinho </a>
            ...
            <!-- PRODUTO 9 -->
            <div class='card'>
                <img class='imagemProduto' src='figs jogos/sonic.png' />
                <h4> Sonic </h4>
                <div class='valorProduto'>
                    <h5> R$4,00</h5>
                </div>
